...
import messageModel from "./daos/messages/messages.model.js";
const app = express();
...
let uri = `mongodb+srv://${claves.username}:${claves.password}@${claves.cluster}.qnfm9hs.mongodb.net/${claves.dbname}?retryWrites=true&w=majority&appName=Cluster0`;
